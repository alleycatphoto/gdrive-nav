...
<body>
        ...
        try {
                ...
                foreach ($breadcrumbs as $index => $crumb) {
                    ...
                    if ($index === count($breadcrumbs) - 1) {
                        ...
                        echo '<li class="breadcrumb-item" style="animation-delay: ' . $delay . 's">'
                            . '<a href="/folder?folder=' . htmlspecialchars($crumb['id']) . '">'
            ...
            if (empty($files)) {
                ...
                foreach ($files as $file) {
                    ...
                    $cardLink = $file['isFolder'] ? '/folder?folder=' . htmlspecialchars($file['id']) : 'javascript:void(0);';
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <?php else: ?>
                                    <h6 class="card-title">
                                        <a href="/folder?folder=<?php echo htmlspecialchars($file['id']); ?>"
                                    ...
                                    <a href="/folder?folder=<?php echo htmlspecialchars($file['id']); ?>" class="folder-link">
    ...
    <?php include __DIR__ . '/../includes/scripts_folder.php'; ?>
</body>
</html>